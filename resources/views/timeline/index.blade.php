                ...
                <div class="modal-dialog  modal-lg modal-fullscreen-sm-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="post-modalLabel">Criar publicação</h5>
                            <button type="button" class="btn-close btn shadow-none" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="d-flex align-items-center border-bottom pb-3 mb-4">
                                <div class="user-img">
                                    <img src="https://templates.iqonic.design/product/hope-ui/pro/laravel/public/modules/social-app/images/avatar/01.png"
                                        alt="userimg" class="avatar-60 rounded-circle img-fluid">
                                </div>
                                <form method="POST" action="{{ route('post.store') }}" class="w-100" action="#">
                                    @csrf
                                    <input type="text"  id='body' name="body" class="form-control shadow-none border-0"
                            ...
                            <ul class="row flex-wrap align-items-center list-inline m-0 p-0">
                                <li class="col-md-6 mb-3">
                                    <div class="bg-body rounded p-2 pointer">
                                        <svg width="24" class="me-2" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M21.9999 14.7024V16.0859C21.9999 16.3155 21.9899 16.5471 21.9699 16.7767C21.6893 19.9357 19.4949 22 16.3286 22H7.67126C6.06806 22 4.71535 21.4797 3.74341 20.5363C3.36265 20.1864 3.042 19.7753 2.7915 19.3041C3.12217 18.9021 3.49291 18.462 3.85363 18.0208C4.46485 17.289 5.05603 16.5661 5.42677 16.0959C5.97788 15.4142 7.43078 13.6196 9.44481 14.4617C9.85563 14.6322 10.2164 14.8728 10.547 15.0833C11.3586 15.6247 11.6993 15.7851 12.2705 15.4743C12.9017 15.1335 13.3125 14.4617 13.7434 13.76C13.9739 13.388 14.2043 13.0281 14.4548 12.6972C15.547 11.2736 17.2304 10.8926 18.6332 11.7348C19.3346 12.1559 19.9358 12.6872 20.4969 13.2276C20.6172 13.3479 20.7374 13.4592 20.8476 13.5695C20.9979 13.7198 21.4989 14.2211 21.9999 14.7024Z"
                                                fill="currentColor"></path>
                                    ...
                                    <div class="bg-body rounded p-2 pointer">
                                        <svg width="24" class="me-2" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <circle opacity="0.4" cx="12" cy="12" r="10"
                                                fill="currentColor" />
                                            <path
                                                d="M9.70986 9.39758C8.73513 8.42277 7.14907 8.42285 6.17435 9.39758C5.94188 9.63 5.94188 10.0069 6.17435 10.2394C6.40685 10.4718 6.78376 10.4718 7.01618 10.2394C7.52681 9.72879 8.35759 9.72883 8.86814 10.2394C8.98439 10.3556 9.13669 10.4138 9.289 10.4138C9.4413 10.4138 9.59369 10.3556 9.70986 10.2394C9.94232 10.0069 9.94232 9.63004 9.70986 9.39758Z"
                                                fill="currentColor" />
                                            <path
                                                d="M17.5719 9.39758C16.5972 8.42285 15.0111 8.42277 14.0364 9.39758C13.8039 9.63 13.8039 10.0069 14.0364 10.2394C14.2689 10.4718 14.6458 10.4718 14.8782 10.2394C15.3888 9.72879 16.2196 9.72875 16.7302 10.2394C16.8465 10.3556 16.9988 10.4138 17.1511 10.4138C17.3034 10.4138 17.4558 10.3556 17.5719 10.2394C17.8044 10.0069 17.8044 9.63004 17.5719 9.39758Z"
                                                fill="currentColor" />
                                            <path
                                                d="M17.151 12.4751H6.59548C6.26673 12.4751 6.00024 12.7416 6.00024 13.0703C6.00024 16.3087 8.63489 18.9433 11.8733 18.9433C15.1116 18.9433 17.7463 16.3087 17.7463 13.0703C17.7463 12.7416 17.4798 12.4751 17.151 12.4751ZM11.8733 17.7529C9.49286 17.7529 7.52161 15.9676 7.22837 13.6656H16.5182C16.2249 15.9676 14.2536 17.7529 11.8733 17.7529Z"
                                                fill="currentColor" />
                                ...
                                <li class="col-md-6 mb-3">
                                    <div class="bg-body rounded p-2 pointer">
                                        <svg width="28" class="me-2" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect opacity="0.4" x="1" y="6" width="22"
                                                height="12.7368" rx="1" fill="currentColor" />
                                            <path
                                                d="M4.47363 9.47363V15.2631H7.94732M9.68416 9.47363V15.2631M11.421 9.47363L13.1387 15.1993C13.1444 15.2183 13.1713 15.2183 13.177 15.1993L14.8947 9.47363M19.5263 15.2631H16.6315V12.5M19.5263 9.47363H16.6315V12.5M16.6315 12.5H19.5263"
                                                    ...
                                                    <div class="d-flex align-items-top">
                                                        <svg class="icon-24" width="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                ...
                                                                fill="currentColor"></path>
                                                            <circle opacity="0.4" cx="19.5" cy="4.5"
                            ...
                            <button type="submit" title="Salvar" class="btn btn-primary d-block w-100 mt-3">Postar</button>
                            </div>
                        </div>
                    </div>
                </div>
