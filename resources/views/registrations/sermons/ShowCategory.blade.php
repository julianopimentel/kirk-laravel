                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            Categoria</button>
                        @include('registrations.sermons.add.AddCategory')
                        </div>
                        <div class="card-body">
                                            ...
                                            <td width="1%">
                                                @if ($appPermissao->edit_sermons == true)
                                                    <a href="" target="_blank" data-bs-toggle="modal"
                                                        data-bs-target="#updateCategory{{ $category->id }}"><svg
                                                    ...
                                                    @include('registrations.sermons.add.EditCategory')
                                                @endif
                                            </td>
                                            <td width="1%">
                                                @if ($appPermissao->delete_sermons == true)
                                                    <form
                                                        ...
                                                        @method('DELETE')
                                                        @csrf
                                                        <a class="show_confirm" data-toggle="tooltip" title='Delete'><svg xmlns="http://www.w3.org/2000/svg" width="20"
