<x-app-layout layout="boxedfancy" :assets="$assets ?? []">
    <div class="row">
        <div class="card">
                            ...
                            <div class="tab-content iq-tab-fade-up" id="v-pills-tabContent">
                                                    ...
                                                    <div class="input-group">
                                                        <select id="country-dd" name="country-dd"
                                                            ...
                                                            @foreach ($countries as $data)
                                                                @if ($data->id == $institution->country)
                                                    ...
                                                    <div class="input-group">
                                                        <select name="state-dd" id="state-dd" class="form-select">
                                                            @foreach ($state as $data)
                                                                <option value="{{ $data->id }}"
                                                                    @if ($data->id == $institution->state) selected="true" @endif>
                                                                    {{ $data->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        <select id="city-dd" name="city-dd" class="form-select">
                                                            @foreach ($city as $data)
                                                                <option value="{{ $data->id }}"
                                                                    @if ($data->id == $institution->city) selected="true" @endif>
                                                                    {{ $data->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                    ...
                                    <div class="mb-3 form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="compartilhar_link"
                                            id="flexSwitchCheckChecked"
                                            {{ $institution->compartilhar_link == true ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Ativar módulo de
                                            cadastro rápido</label>
                                    </div>
                                    <p>
                                    <div class="col-md-12">
            ...
            <div class="col-6">
                <button class="btn btn-success" type="submit" title="Salvar" data-toggle="modal"
                    data-target="#exampleModalScrollable">Salvar</button>
                <a href="{{ route('account.index') }}" class="btn btn-primary" type="submit">Voltar</a>
            </div>
        </div>
    </div>
    </div>
