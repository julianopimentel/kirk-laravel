                            ...
                            <div class="mb-3">
                                ...
                                @if ($appPermissao->add_retirada_financial == true)
                                    @if ($amount > 1)
                                        ...
                                        @if ($contas_financeiras->count() >= 2)
                                            <a class="btn btn-info" href="{{ route('transfer') }}" type="submit">
                                ...
                                <table class="table table-sm table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($transactions as $transaction)
                                            <tr @if ($transaction->type == 'O') class="table-danger" @endif
                                                data-bs-toggle="modal"
                                                data-bs-target="#ViewFinanceiro{{ $transaction->id }}">
                                                <td>
