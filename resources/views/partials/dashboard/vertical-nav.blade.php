<ul class="navbar-nav iq-main-menu" id="sidebar">
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('home.index')) }}" aria-current="page" href="{{ route('home.index') }}">
            <i class="icon">
                <svg class="icon-20" width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    @if ($appPermissao->home_oracao == true)
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('indexOracao')) }}" aria-current="page"
                ...
                <i class="icon">
                    <svg class="icon-20" width="20px" height="20px" viewBox="0 -64 640 640" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M204.8 230.4c-10.6-14.1-30.7-17-44.8-6.4-14.1 10.6-17 30.7-6.4 44.8l38.1 50.8c4.8 6.4 4.1 15.3-1.5 20.9l-12.8 12.8c-6.7 6.7-17.6 6.2-23.6-1.1L64 244.4V96c0-17.7-14.3-32-32-32S0 78.3 0 96v218.4c0 10.9 3.7 21.5 10.5 30l104.1 134.3c5 6.5 8.4 13.9 10.4 21.7 1.8 6.9 8.1 11.6 15.3 11.6H272c8.8 0 16-7.2 16-16V384c0-27.7-9-54.6-25.6-76.8l-57.6-76.8zM608 64c-17.7 0-32 14.3-32 32v148.4l-89.8 107.8c-6 7.2-17 7.7-23.6 1.1l-12.8-12.8c-5.6-5.6-6.3-14.5-1.5-20.9l38.1-50.8c10.6-14.1 7.7-34.2-6.4-44.8-14.1-10.6-34.2-7.7-44.8 6.4l-57.6 76.8C361 329.4 352 356.3 352 384v112c0 8.8 7.2 16 16 16h131.7c7.1 0 13.5-4.7 15.3-11.6 2-7.8 5.4-15.2 10.4-21.7l104.1-134.3c6.8-8.5 10.5-19.1 10.5-30V96c0-17.7-14.3-32-32-32z"fill="currentColor">
                        </path>
                    </svg>
                </i>
    ...
    @endif
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#registrationsmenu" role="button"
    ...
    @if ($appPermissao->view_media == true)
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('media.folder.index')) }}" aria-current="page"
                ...
                <span>{{ __('layout.documents') }}<span
                        class="badge rounded-pill bg-info">Beta</span></span>
            </a>
        </li>
    @endif
    ...
    @if ($appPermissao->view_financial == true)
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('transaction.index')) }}" aria-current="page"
    ...
    @if ($appPermissao->report_view == true)
        <li class="nav-item mb-5">
            <a class="nav-link" data-bs-toggle="collapse" href="#reportmenu" role="button" aria-expanded="false"
                aria-controls="sidebar-special">
                <i class="icon">
                    <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor"
            ...
            <ul class="sub-nav collapse" id="reportmenu" data-bs-parent="#sidebar">
                <li class="nav-item">
