                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Recados</h4>
                            </div>
                            @if ($appPermissao->add_message == true)
                                <a href="{{ route('message.create') }}" class="btn btn-primary" type="submit">Adicionar
                                </a>
                            @endif
                        </div>
                        <p>
                            ...
                            <tbody>
                                @foreach ($notes as $note)
                                    <tr>
                                        ...
                                        <td width="1%">
                                            @if ($appPermissao->view_message == true)
                                                <a href="{{ route('message.show', $note->id) }}"><svg
                                        ...
                                        <td width="1%">
                                            @if ($appPermissao->edit_message == true)
                                                <a href="{{ route('message.edit', $note->id) }}"><svg class="icon-20"
