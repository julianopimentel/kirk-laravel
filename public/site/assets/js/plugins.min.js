    ...
    var n = {
        ...
        event: function () {
            ...
            if (
                ...
                "" == !d &&
                    a("ul.navbar-nav > li:contains('" + d + "')").addClass(
                        "active"
                    );
            }
            n.hasClass("navbar-sidebar")
                ...
                n.find("ul.nav").hasClass("navbar-center") &&
                    ...
                    n.hasClass("navbar-sidebar")
                        ? a("nav.navbar.bootsnav ul.nav").each(function () {
                              a("a.dropdown-toggle", this).off("click"),
                                  ...
                                  a(".dropdown-menu", this).addClass(
                                      "animated"
                                  ),
                                  a("li.dropdown", this).on(
                                      "mouseenter",
                                      function () {
                                          return (
                                  ...
                                  a(this).on("mouseleave", function () {
                                      return (
                                          ...
                                          a(".col-menu", this)
                                              ...
                                              .fadeOut()
                                              .removeClass(e),
                                          a(".col-menu", this).removeClass(
                                              "on"
                                          ),
                                          a("li.dropdown", this).removeClass(
                                              "on"
                                          ),
                                          !1
                                      );
                        ...
                        : a("nav.navbar.bootsnav ul.nav").each(function () {
                              a("a.dropdown-toggle", this).off("click"),
                                  ...
                                  a(this).on("mouseleave", function () {
                                      return (
                                          a(".dropdown-menu", this).removeClass(
                                              e
                                          ),
                                          a(".dropdown-menu", this)
                                              .eq(0)
